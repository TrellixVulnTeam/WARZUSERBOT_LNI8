...
pm_caption += f"┣᭙ꪖ᥅ƺẞø† ~ {LEGENDversion}\n"
pm_caption += f"┣᭙ꪖ᥅ƺ    ~ [Owner](https://t.me/TheWarZ_Boy)\n"
pm_caption += f"┣Support ~ [G𝖗ουρ](https://t.me/WarZSupport)\n"
pm_caption += f"┣Řepô    ~ [Rєρο](https://github.com/Team-WarZ/WarZBOT)\n"
pm_caption += f"**╰────────────**\n"
